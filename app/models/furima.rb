class Furima
  ...
  def save
    ...
    DeliveryAddress.create(postal_code: postal_code, prefectures_id: prefectures_id, municipalities: municipalities, house_number: house_number, building_name: building_name, purchase_record_id: purchase_record.id)
  end
